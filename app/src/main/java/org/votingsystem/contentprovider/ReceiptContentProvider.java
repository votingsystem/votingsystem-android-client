...
public class ReceiptContentProvider extends ContentProvider {
    ...
    public static ContentValues getContentValues(VoteContainer voteWrapper, ReceiptContainer.State state) {
        ContentValues values = new ContentValues();
        values.put(SERIALIZED_OBJECT_COL, ObjectUtils.serializeObject(voteWrapper));
        values.put(TYPE_COL, voteWrapper.getOperationType().toString());
        values.put(STATE_COL, state.toString());
        if (voteWrapper.getLocalId() == null)
