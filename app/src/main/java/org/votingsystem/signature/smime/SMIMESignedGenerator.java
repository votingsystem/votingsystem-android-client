    ...
    extends SMIMEGenerator
{
     ...
     * @throws org.bouncycastle2.cms.CMSException if an error occurse processing the store.
    ...
    private MimeMultipart make(
        MimeBodyPart    content, String fileName)
     ...
     * @throws org.bouncycastle2.mail.smime.SMIMEException if an exception occurs in processing the signature.
    ...
    {
        return make(makeContentBodyPart(content), SMIMEUtil.getProvider(sigProvider), filename);
    }
    ...
    public MimeMultipart generate(
        MimeBodyPart    content,
        Provider        sigProvider, String fileName)
        throws NoSuchAlgorithmException, SMIMEException
    {
        return make(makeContentBodyPart(content), sigProvider, fileName);
    }
    ...
    public MimeMultipart generate(
        MimeMessage     message,
        String          sigProvider, String fileName)
        throws NoSuchAlgorithmException, NoSuchProviderException, SMIMEException
    {
        return generate(message, SMIMEUtil.getProvider(sigProvider), fileName);
    }
        ...
        throws NoSuchAlgorithmException, SMIMEException
    {
        ...
        return make(makeContentBodyPart(message), sigProvider, fileName);
    }
    ...
    public MimeMultipart generate(
        ...
        throws SMIMEException
    {
        return make(makeContentBodyPart(content), fileName);
    }
