...
public class PDFSignedGenerator extends CMSSignedGenerator {
	
	public static final String TAG = "PDFSignedGenerator";
    ...
    public PDFSignedGenerator(PrivateKey privateKey,
