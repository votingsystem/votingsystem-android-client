 ...
 */
public class AnonymousDelegation extends ReceiptContainer {

    private static final long serialVersionUID = 1L;

    public static final String TAG = AnonymousDelegation.class.getSimpleName();
    ...
    public AnonymousDelegation(Integer weeksOperationActive, Date dateFrom, Date dateTo,
    ...
    public static AnonymousDelegation parse(JSONObject jsonObject) throws Exception {
        ...
        AnonymousDelegation result = new AnonymousDelegation(jsonObject.getInt("weeksOperationActive"),
